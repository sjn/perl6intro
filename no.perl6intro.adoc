= Perl 6 Introduksjon
:description: En generell introduksjon til Perl 6
:Author: Naoum Hankache; Salve J. Nilsen
:keywords: perl6, perl 6, introduksjon, perl6intro, perl 6 introduuksjon, perl 6 veiledning, perl 6 intro
:Email: naoum@hankache.com, sjn@cpan.org
:Revision: 1.0
:icons: font
...
Formålet med dette dokumentet er å gi en rask oversikt over programmeringsspråket Perl 6.
Målgruppen er Perl 6-nybegynnere som ønsker å komme raskt i gang.

Noen av seksjonene i dette dokumentet vil henvise til andre mer komplette og kurante deler av Perl 6 sin dokumentasjon.
Referansene er til for de som ønsker å fordype seg i et spesielt tema.

Dette dokumentet har eksempler for de fleste temaene som tas opp.
Bruk gjerne litt tid på å reprodusere eksemplene for hjelpe med forståelsen av disse.

.Lisens
Dette verket er lisensiert med Creative Commons Attribution-ShareAlike 4.0 International License.
For å lese denne lisensen, gå til følgende webside:

* http://creativecommons.org/licenses/by-sa/4.0/.

.Bidrag
Om du ønsker å bidra til dette dokumentet ta gjerne en titt innom:

* http://github.com/hankache/perl6intro

.Tilbakemelding
Tilbakemeldinger og innspill er velkommen:
naoum@hankache.com - Engelsk
sjn@cpan.org - Norsk

.Oversettelser
* Fransk: http://fr.perl6intro.com
* Tysk: http://de.perl6intro.com
* Japansk: http://ja.perl6intro.com
* Spansk: http://es.perl6intro.com
* Norsk: http://no.perl6intro.com

:sectnums:
== Introduksjon
=== Hva er Perl 6?
Perl 6 er et universell, gradvis typet, høynivå programmeringsspråk.
Perl 6 er et multiparadigmespråk. Det støtter prosedyrell, objektorientert og funksjonell programmering.

.Perl 6 motto:
* TMTOWTDI (Uttales Tim Toady): There is more than one way to do it. (Det fins mer enn én måte å gjøre det.)
* Enkle ting bør forbli enkle, vanskelige ting bør bli lettere og umulige ting bør være vanskelig.

=== Sjargong
* *Perl 6*: Selve spesifikasjonen av språket, med tilhørende automatiske tester.
Implementasjoner som vellykket kjører spesifikasjons-testene ansees å være Perl 6.
* *Rakudo*: En Perl 6 kompilator.
* *Rakudobrew*: Et installasjonsverktøy for Rakudo.
* *Panda*: Et installasjonsverktøy for Perl 6 moduler.
* *Rakudo Star*: En pakke som inneholder Rakudo, Panda, en samling av Perl 6-moduler, og dokumentasjon.

=== Installering av Perl 6
.Linux
. Installér Rakudobrew: https://github.com/tadzik/rakudobrew

. Installér Rakudo: Type the following command in the terminal `rakudobrew build moar`

. Installér Panda: Type the following command in the terminal `rakudobrew build panda`

.OS X
Det finnes fire alternativer:

* Følg stegene for installering på Linux
* Installér med homebrew: `brew install rakudo-star`
* Installér med MacPorts: `sudo port install rakudo`
* Last ned og installér nyeste .dmg pakke fra http://rakudo.org/downloads/star/

.Windows
. Last ned nyeste .msi pakke fra http://rakudo.org/downloads/star/ +
